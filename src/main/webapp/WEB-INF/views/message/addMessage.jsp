			...
			<div class="toolBar">
				<form class="formArea" id="forArea" method="post"
					...
					<div class="form-group">
						...
						<select  id="SelectID" name="messageCategory 	 "style="font-size: 20px; width: 108px; height: 30px;">
						<option value="國片討論">國片討論
						<option value="募資討論">募資討論 </select> <br>
						
					</div>

					<div style="font-size: 20px; padding: 10px 0px">標題</div>
					<div class="col-lg-10">
						<input id="title" name="messageTitle" type='text'
							style="height: 30px; width: 600px; font-size: 15px; height: 30px"><br>
					</div>
					<div style="font-size: 20px; padding: 10px 0px">內文</div>
					<div
						style="margin: 0 auto; width: 100%; padding: 10px 0px; font-size: 15px">
