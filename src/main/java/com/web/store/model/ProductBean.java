...
//	@JsonIgnore
	...
	public ProductBean(Integer productId, String title, String author, 
			...
			String productNo, Blob coverImage, int companyId, String category, String status) {
	...
	public ProductBean(Integer productId, String title, String author, 
			Double price, Double discount, String fileName, 
			String productNo, Blob coverImage, Integer stock, String category, CompanyBean companyBean, String status) {
		this.productId = productId;
		this.title = title;
		this.author = author;
		this.price = price;
